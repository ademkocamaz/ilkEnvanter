...
SECRET_KEY = 'django-insecure-br#l^jf)*=1t(@0l*0nwx@(1yyza87$45ppaxo-9mcbfc8us=^'
...
BATON = {
    'SITE_HEADER': 'ilkEnvanter',
    'SITE_TITLE': 'ilkEnvanter Yönetim Paneli',
    'INDEX_TITLE': 'ilkEnvanter - Envanter Yönetimine, Hoşgeldiniz.',
